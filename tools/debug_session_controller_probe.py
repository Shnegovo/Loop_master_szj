...
def main() -> int:
    ...
    _assert(not _command(state, "reset").execution_enabled, "reset should require run-control policy")
    _assert(not _command(state, "run_to_cursor").execution_enabled, "run_to_cursor should require run-control policy")
    ...
    _assert(_command(state, "reset").execution_enabled, "reset should enable when run-control policy allows")
    ...
    _assert(_command(state, "run_to_cursor").execution_enabled, "run_to_cursor should enable when run-control policy allows")
